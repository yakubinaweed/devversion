...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    sidebarLayout(
      sidebarPanel(
        style = "padding-right: 15px;", # Apply custom styling
        ...
        uiOutput("app_message"), # For displaying messages
        hr(),
      ...
      mainPanel(
        style = "padding-left: 15px;", # Apply custom styling
  ...
  tabPanel(
    ...
    fluidRow(
      ...
      column(8,
             uiOutput("gmm_results_ui") # Renders GMM plot and summary dynamically
      )
    )
  ),
