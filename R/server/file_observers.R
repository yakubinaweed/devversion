...
shinyFiles::shinyDirChoose(
  input,
  id = 'select_dir_btn', # Renamed from select_output_dir
  roots = c(
    home = '~',
    wd = '.'
  ),
...
observeEvent(input$select_dir_btn, { # Renamed from select_output_dir
...
observeEvent(input$enable_directory, { # Renamed from auto_save_graph
